	...
	$(function(){	
		...
		$('.restimeselect .right').append('<option>10:30 - 11:30</option>');
		$('.restimeselect .right').append('<option>11:30 - 12:30</option>');
		$('.restimeselect .right').append('<option>12:30 - 13:30</option>');
		$('.restimeselect .right').append('<option>13:30 - 14:30</option>');
...
//		                	window.location.href= '<%= CLI_HOST_API_URL %>/nggirl/h5/cosmetic/orderSuccess-xhnh.html?v=<%= VERSION %>';
		                	window.location.href= '<%= CLI_HOST_API_URL %>/nggirl/h5/cosmetic/orderList.html?v=<%= VERSION %>';
		                },
		                fail: function (res) {
