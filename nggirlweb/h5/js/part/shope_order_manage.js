	...
	if(sku.length > 0){
				...
				if(data.isRefund == 0){//未做过退款申请
					...
					if(data.canModify == 0){
						...
						if(data.orderStatus[0].num == 1){
							$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'><input type="text" value="'+data.payAcount+'" style=" width:50px; text-align:center;" class="text_padding" /><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_money" /></td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'><select name="" id="" style="padding:7px; border:1px solid #ccc;" class="wuliu_shang">'+getWuLiuMessageFn(data.transCompanyName)+'</select><input type="text" value="'+data.transNum+'" class="text_padding" style="width:100px; padding: 8px;vertical-align: bottom;"/><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="modify_wuliu_hao" /><br /><br /><div class="look_wuliu"><img src="images/look_icon.jpg" style="width:20px; vertical-align:bottom;" alt="" /><span>查看物流</span></div></td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>无</td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
						}else{
							$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'>'+data.payAcount+'</td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'><select name="" id="" style="padding:7px; border:1px solid #ccc;" class="wuliu_shang">'+getWuLiuMessageFn(data.transCompanyName)+'</select><input type="text" value="'+data.transNum+'" class="text_padding" style="width:100px; padding: 8px;vertical-align: bottom;"/><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="modify_wuliu_hao" /><br /><br /><div class="look_wuliu"><img src="images/look_icon.jpg" style="width:20px; vertical-align:bottom;" alt="" /><span>查看物流</span></div></td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>无</td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
						}
					}else{
						//仅待付款状态可修改金额
						if(data.orderStatus[0].num == 1){
							$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'><input type="text" value="'+data.payAcount+'" style=" width:50px; text-align:center;" class="text_padding" /><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_money" /></td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'>物流单号：'+data.transNum+'</td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>无</td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
						}else{
							$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'>'+data.payAcount+'</td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'>物流单号：'+data.transNum+'</td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>无</td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
						}
					}
					...
					if(data.refundStatus == 0){//退款申请状态,[0-未处理,1-已处理]
						...
						if(data.canModify == 0){
							...
							//仅待付款状态可修改金额
							if(data.orderStatus[0].num == 1){
								$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'><input type="text" value="'+data.payAcount+'" style=" width:50px; text-align:center;" class="text_padding" /><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_money" /></td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'>物流单号：'+data.transNum+'</td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>'+data.refundReason+'<p class="font_color_red">（未处理）</p></td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
							}else{
								$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'>'+data.payAcount+'</td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'>物流单号：'+data.transNum+'</td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>'+data.refundReason+'<p class="font_color_red">（未处理）</p></td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
							}
						}
						...
						if(data.canModify == 0){
							...
							//仅待付款状态可修改金额
							if(data.orderStatus[0].num == 1){
								$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'><input type="text" value="'+data.payAcount+'" style=" width:50px; text-align:center;" class="text_padding" /><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_money" /></td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'>物流单号：'+data.transNum+'</td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>'+data.refundReason+'<p class="font_color_red">（已处理）</p></td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
							}else{
								$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td rowspan='+sku.length+'><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td><p>'+sku[x].title+'</p></td><td>'+sku[x].num+'</td><td rowspan='+sku.length+'>'+data.createTime+'</td><td rowspan='+sku.length+'>'+data.payAcount+'</td><td rowspan='+sku.length+'><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td rowspan='+sku.length+'>物流单号：'+data.transNum+'</td><td rowspan='+sku.length+'>'+data.customerNote+'</td><td rowspan='+sku.length+'>'+data.sellerNote+'</td><td rowspan='+sku.length+'>'+data.refundReason+'<p class="font_color_red">（已处理）</p></td><td rowspan='+sku.length+'>'+getMenuStatusFn(data.strings)+'</td><td rowspan='+sku.length+'>'+data.modifyer+'</td><td rowspan='+sku.length+'>'+data.customerName+'</td><td rowspan='+sku.length+'>'+data.customerPhone+'</td><td rowspan='+sku.length+'>'+data.customerAddress+'</td></tr>');
							}
						}
		...
		if(data.isRefund == 0){//未做过退款申请
			...
			if(data.canModify == 0){
				//仅待付款状态可修改金额
				if(data.orderStatus[0].num == 1){
					$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td></td><td></td><td>'+data.createTime+'</td><td><input type="text" value="'+data.payAcount+'" style=" width:50px; text-align:center;" class="text_padding" /><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_money" /></td><td><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td><select name="" id="" style="padding:7px; border:1px solid #ccc;" class="wuliu_shang">'+getWuLiuMessageFn(data.transCompanyName)+'</select><input type="text" value="'+data.transNum+'" class="text_padding" style="width:100px; padding: 8px;vertical-align: bottom;"/><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="modify_wuliu_hao" /><br /><br /><div class="look_wuliu"><img src="images/look_icon.jpg" style="width:20px; vertical-align:bottom;" alt="" /><span>查看物流</span></div></td><td>'+data.customerNote+'</td><td>'+data.sellerNote+'</td><td>无</td><td>'+getMenuStatusFn(data.strings)+'</td><td>'+data.modifyer+'</td><td>'+data.customerName+'</td><td>'+data.customerPhone+'</td><td>'+data.customerAddress+'</td></tr>');
				}else{
					$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td></td><td></td><td>'+data.createTime+'</td><td>'+data.payAcount+'</td><td><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td><select name="" id="" style="padding:7px; border:1px solid #ccc;" class="wuliu_shang">'+getWuLiuMessageFn(data.transCompanyName)+'</select><input type="text" value="'+data.transNum+'" class="text_padding" style="width:100px; padding: 8px;vertical-align: bottom;"/><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="modify_wuliu_hao" /><br /><br /><div class="look_wuliu"><img src="images/look_icon.jpg" style="width:20px; vertical-align:bottom;" alt="" /><span>查看物流</span></div></td><td>'+data.customerNote+'</td><td>'+data.sellerNote+'</td><td>无</td><td>'+getMenuStatusFn(data.strings)+'</td><td>'+data.modifyer+'</td><td>'+data.customerName+'</td><td>'+data.customerPhone+'</td><td>'+data.customerAddress+'</td></tr>');
				}
			}else{
				//仅待付款状态可修改金额
				if(data.orderStatus[0].num == 1){
					$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td></td><td></td><td>'+data.createTime+'</td><td><input type="text" value="'+data.payAcount+'" style=" width:50px; text-align:center;" class="text_padding" /><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_money" /></td><td><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td>物流单号：'+data.transNum+'</td><td>'+data.customerNote+'</td><td>'+data.sellerNote+'</td><td>无</td><td>'+getMenuStatusFn(data.strings)+'</td><td>'+data.modifyer+'</td><td>'+data.customerName+'</td><td>'+data.customerPhone+'</td><td>'+data.customerAddress+'</td></tr>');
				}else{
					$('.shope_order_manage .shope_order_manage_table tbody').append('<tr orderId='+data.orderId+'><td><input type="checkbox" /><span>订单编号:'+data.orderCode+'</span><br /><span>支付来源：'+data.paySource+'</span></td><td></td><td></td><td>'+data.createTime+'</td><td>'+data.payAcount+'</td><td><select name="" id="" style=" padding:7px; border:1px solid #ccc;">'+getWuLiuOrderStatusMessage(data.orderStatus)+'</select><img src="images/u84.png" style="width:20px; vertical-align: middle;" alt="" class="shope_order_manage_table_modify_status" /></td><td>物流单号：'+data.transNum+'</td><td>'+data.customerNote+'</td><td>'+data.sellerNote+'</td><td>无</td><td>'+getMenuStatusFn(data.strings)+'</td><td>'+data.modifyer+'</td><td>'+data.customerName+'</td><td>'+data.customerPhone+'</td><td>'+data.customerAddress+'</td></tr>');
				}
			}
