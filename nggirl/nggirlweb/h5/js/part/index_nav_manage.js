$(function(){	
	...
	$('.index_nav_btn .index_nav_btn_add').click(function(e) {
        $('.index_nav_manage_box .index_nav_lan').append('<div class="index_nav_lan_li"><div class="index_nav_lan_li_san" style="overflow:hidden;"><div class="inl_lan_name" contenteditable="true">新增专栏'+(parseInt($('.index_nav_lan .index_nav_lan_li').length)+1)+'</div><input type="text" class="inl_lan_index" /><img src="images/img_delete.png" alt="" class="inl_lan_del" style=" width:30px; padding:3px;" /></div><input type="button" value="配置跳转页面" style=" display:block;" class="inl_lan_href" /></div>');
    });
