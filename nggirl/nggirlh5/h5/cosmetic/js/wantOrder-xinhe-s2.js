	...
	$(function(){		
		...
		/*$('.restimeselect .right').append('<option>07:30 - 06:00</option>');	
		$('.restimeselect .right').append('<option>09:00 - 07:30</option>');
		$('.restimeselect .right').append('<option>10:30 - 09:00</option>');
		$('.restimeselect .right').append('<option>12:00 - 10:30</option>');
		$('.restimeselect .right').append('<option>13:30 - 12:00</option>');
		$('.restimeselect .right').append('<option>15:00 - 13:30</option>');
		$('.restimeselect .right').append('<option>16:30 - 15:00</option>');
		$('.restimeselect .right').append('<option>18:00 - 16:30</option>');
		$('.restimeselect .right').append('<option>19:30 - 18:00</option>');
		$('.restimeselect .right').append('<option>21:00 - 19:30</option>');*/
		$('.restimeselect .right').append('<option>06:00 - 07:30</option>');	
		$('.restimeselect .right').append('<option>07:30 - 09:00</option>');
		$('.restimeselect .right').append('<option>09:00 - 10:30</option>');
		$('.restimeselect .right').append('<option>10:30 - 12:00</option>');
		$('.restimeselect .right').append('<option>12:00 - 13:30</option>');
		$('.restimeselect .right').append('<option>13:30 - 15:00</option>');
		$('.restimeselect .right').append('<option>15:00 - 16:30</option>');
		$('.restimeselect .right').append('<option>16:30 - 18:00</option>');
		$('.restimeselect .right').append('<option>18:00 - 19:30</option>');
		$('.restimeselect .right').append('<option>19:30 - 21:00</option>');
		...
		function yueFunc(e) {
			...
			checkAccessTokenLogin(function(){
				...
				if($('.right-data').val() == '' || $('.right-data').val() == '请选择预约日期'){
					alert('请选择预约日期');
				}else if($('#address').val() == ''){
					alert('请输入详细地址');
