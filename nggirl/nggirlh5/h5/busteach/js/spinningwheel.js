...
var SpinningWheel = {
	...
	create: function () {
		...
		div.innerHTML = '<div id="sw-header"><div id="sw-cancel">取消</' + 'div><div id="sw-done">确定</' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"><div id="sw-inframe"></div></' + 'div>';
