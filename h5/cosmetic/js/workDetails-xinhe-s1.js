...
//点击查看更多晒单
    ...
    $('.gl-pic>ul>li img').live("click", function (e) {
        window.location.href = "workDetails-xinhe-s1.html?workId=" + $(this).attr('workId')+'&v=<%= VERSION %>';
    });
...
//点击“立即预约”按钮
    $('.f-center').click(function (e) {
        ...
        },'workDetails-xinhe-s1.html'+window.location.search);
...
function getZhifuBaoLinkUrl(workId,dresserId,time){
    var str = "<%= WEIXIN_BOUND_DOMAIN_URL %>/nggirl/h5/cosmetic/wantOrder-xinhe-s1.html?workId="
