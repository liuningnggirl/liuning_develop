	...
	$(function(){	
		...
		$('.restimeselect .right').append('<option>08:00 - 10:00</option>');
		$('.restimeselect .right').append('<option>10:00 - 12:00</option>');
		$('.restimeselect .right').append('<option>12:00 - 14:00</option>');
		$('.restimeselect .right').append('<option>14:00 - 16:00</option>');
		$('.restimeselect .right').append('<option>16:00 - 18:00</option>');
		$('.restimeselect .right').append('<option>18:00 - 20:00</option>');
