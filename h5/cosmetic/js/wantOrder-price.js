wx.ready(function(){
	...
	$(function(){		
		...
		var remoteurl = '<%= CLI_HOST_API_URL %>/nggirl/app/cli/works/getWorksDetail/1.2';
		// 从地址栏中取得
		...
		function yueFunc(e) {
			...
			checkAccessTokenLogin(function(){
				...
				var resurl = '<%= CLI_HOST_API_URL %>/nggirl/app/cli/works/weixin/getReservationDirect/1.4.2';
