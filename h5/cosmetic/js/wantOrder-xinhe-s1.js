	...
	$(function(){	
		...
		/*$('.restimeselect .right').append('<option>07:00 - 06:00</option>');	
		$('.restimeselect .right').append('<option>08:00 - 07:00</option>');
		$('.restimeselect .right').append('<option>09:00 - 08:00</option>');
		$('.restimeselect .right').append('<option>10:00 - 09:00</option>');
		$('.restimeselect .right').append('<option>12:00 - 11:00</option>');
		$('.restimeselect .right').append('<option>14:00 - 13:00</option>');
		$('.restimeselect .right').append('<option>15:00 - 14:00</option>');
		$('.restimeselect .right').append('<option>16:00 - 15:00</option>');
		$('.restimeselect .right').append('<option>17:00 - 16:00</option>');
		$('.restimeselect .right').append('<option>18:00 - 17:00</option>');
		$('.restimeselect .right').append('<option>19:00 - 18:00</option>');
		$('.restimeselect .right').append('<option>20:00 - 19:00</option>');
		$('.restimeselect .right').append('<option>21:00 - 20:00</option>');*/
		
		$('.restimeselect .right').append('<option>06:00 - 07:00</option>');	
		$('.restimeselect .right').append('<option>07:00 - 08:00</option>');
